...
export const DISHES: Dish[] = [
  ...
  },
  {
    ...
    category: 'dairy',
    fromHealthFoodTable: true,
    aliases: ['greek yogurt', 'greek yoghurt', 'hung curd'],
    note: 'Distinct from plain curd: hung/strained, visibly thicker. The Food row names both because it is one portion target, not because they photograph the same.',
  },
  {
    slug: 'dal',
    name: 'Dal',
  ...
  // ── Additional fragments seen in the 37 real Meal rows ──────────────────
  {
    ...
    name: 'Paneer',
    category: 'dairy',
    aliases: ['paneer', 'paneer cubes', 'cottage cheese'],
    note: 'Logged bare ("Paneer (75g) + sabzi + 1 roti") as well as as bhurji. A different picture from paneer-bhurji.',
  },
